...
```{r echo=F,fig.align='center', out.width="47%",fig.show="hold", fig.pos="H",fig.cap="Neural Network Turning Results"}
...
```{r, echo=F,fig.align='center', out.height = "70%",out.width = "70%", fig.cap="Receiver Operating Characteristic (ROC) curve for each Model.", fig.pos="H"}
